...
def get_input_args():
    ...
    parser.add_argument('image_path', default='./flowers/test/1/image_06743.jpg', action="store", type = str)
    parser.add_argument('--dir', action="store",dest="data_dir", default="./flowers/")
    parser.add_argument('--saved_checkpoint', default='checkpoint.pth', help='Saved checkpoint location')
