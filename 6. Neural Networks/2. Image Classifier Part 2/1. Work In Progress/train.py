...
#    train(model, in_arg.epochs, in_arg.learning_rate, criterion, optimizer, train_loader, validation_loader)
    ...
    # Save checkpoint
    save_checkpoint(in_arg.save_dir, model, optimizer, in_arg.epochs, in_arg.arch, image_datasets)
...
##############################################   
def save_checkpoint(save_dir, model, optimizer, epochs, arch, image_datasets):
    ## Save the checkpoint
    model.cpu()
