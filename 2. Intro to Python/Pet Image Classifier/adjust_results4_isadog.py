...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    with open(dogfile, "r") as infile:
        ...
        while line != "":
            ...
            #pass   
            if strip_line not in dognames_dic:
...
#    print('Steve results_dic')
#    print(results_dic)
#    print('Steve dognames_dic')
#    print(dognames_dic)
#    items_in_dic = len(dognames_dic)
...
#            print('Steve: Pet Image Label Is of Dog')
            
            # Classifier Label IS image of Dog (e.g. found in dognames_dic)
            # appends (1, 1) because both labels are dogs
            if results_dic[key][1] in dognames_dic:
                results_dic[key].extend((1, 1))
#                print('Steve: Classifier label is image of dog')
...
#                print('Steve: classifier label is not image of dog')

        # Pet Image Label IS NOT a Dog image (e.g. NOT found in dognames_dic)
        else:
#            print('Steve: Pet image label is not a dog image')
...
#                print('Steve: classifier label is of dog because only classifier label is a dog')
...
#                print('Steve: classifier labels is not a dog')
